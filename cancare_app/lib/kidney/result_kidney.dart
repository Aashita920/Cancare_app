...
class KidneyResult extends StatelessWidget {
  final int resultScore;
  final VoidCallback resetHandler;

  KidneyResult(this.resultScore, this.resetHandler);
  //const Result({Key? key}) : super(key: key);

  String get resultPhrase {
    String resultText;
    if (resultScore >= 40) {
      resultText = 'You are likely to have kidney Cancer';
    } else if (resultScore >= 20 && resultScore <= 10) {
      resultText = 'You have few chances of having kidney Cancer';
    } else {
      resultText = 'You have very less chances of having kidney Cancer';
    }
    return resultText;
  }
